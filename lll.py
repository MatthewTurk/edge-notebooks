...
frames_per_sec="2.8" # for making the video using ffmpeg
...
#I zoomed in 1.07 times for 9 times/frames
    ...
    command="ffmpeg -r "+frames_per_sec+" -f image2 -s 1920x1080 -start_number 1 -i "+save_place+"/pic%d.png -vframes 75 -vcodec libx264 -crf 15  -b 5000K -vb 20M -pix_fmt yuv420p "+save_place+"/movie.mp4"
